...
-- Agregar columna practica si no existe (tabla ya existía sin ella)
ALTER TABLE grupos ADD COLUMN IF NOT EXISTS practica TEXT DEFAULT 'P2';
UPDATE grupos SET practica = 'P2' WHERE practica IS NULL OR practica = '';
ALTER TABLE grupos ALTER COLUMN practica SET NOT NULL;
ALTER TABLE grupos ADD CONSTRAINT grupos_practica_check CHECK (practica IN ('P1','P2','P3','TutoriasPost'));
